...
function Banner() {
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto overflow-x-hidden md:px-20 sm:px-5 py-3 flex flex-col md:flex-row my-10">
        <div className="w-full order-2 md:w-1/2 mt-12 md:mt-32 px-4 sm:px-5 md:px-0">
          <div className="space-y-11">
            ...
            <p>
              ...
              It's a haven for readers and a hub for literary events. Come in,
              grab a cup of coffee, and lose yourself in a good book. We can't
              wait to see you!
            </p>
